...
export const nixpendAdapter = {
    // find patient by type and value
    async findPatient(type, value) {
    ...
    // update patient
    async updatePatient(patient_id, value) {
    ...
    async getPractitioners(branch, department) {
        let data;
        let properties = {
            method: 'GET',
            headers: {
    ...
    async rescheduleAppointment(appointment_id, appointment_details) {
