export class CreateBooking {
    ...
    sessionRepo;
    patientRepo;
    constructor(bookingRepo, nixpendRepo, sessionRepo, patientRepo) {
        this.bookingRepo = bookingRepo;
        this.nixpendRepo = nixpendRepo;
        this.sessionRepo = sessionRepo;
        this.patientRepo = patientRepo;
    }
    async exec(data, sessionId) {
        ...
        try {
            ...
            if (data.appointment_type === 'session') {
                ...
                session = await this.sessionRepo.findSessionById(sessionId, { tx: tx.session });
            ...
            if (session) {
                const updateSession = this.sessionRepo.updateSession(session._id, {
                ...
                const updatePatient = this.patientRepo.updatePatientStatus(createdBooking.patientNixpendId, 'active', { tx: tx.session });
